...
import { Menubar, MenubarContent, MenubarItem,
    MenubarMenu, MenubarSeparator, MenubarShortcut, MenubarSub, MenubarSubContent, MenubarSubTrigger, MenubarTrigger
    ...
    return (
        <nav className="flex items-center justify-between">
            ...
            <div className="flex gap-3 items-center pl-6">
                <Avatars />
                <Inbox />
                <OrganizationSwitcher afterCreateOrganizationUrl="/" afterLeaveOrganizationUrl="/"
